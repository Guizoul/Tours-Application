...
var searchForm = document.querySelector('.nav__search'); // DELEGATION
...
console.log(document.getElementById('name').value, document.getElementById('email').value, document.getElementById('photo').files[0]);
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              e.preventDefault();
              searchKeyword = document.querySelector('.nav__search-input');
              _context2.next = 4;
              return (0, _search.search)(searchKeyword.value);
